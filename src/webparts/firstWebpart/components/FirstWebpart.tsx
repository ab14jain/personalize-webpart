...
import { ClientsideWebpart, ClientsidePageFromFile, ClientsideText } from "@pnp/sp/clientside-pages";
...
export default class FirstWebpart extends React.Component<IFirstWebpartProps, IFirstWebpartState> {
  ...
  public render(): React.ReactElement<IFirstWebpartProps> {
    ...
    let chkboxWebpart = availableWebpart.map(item => {
        return <div><input type="checkbox" name={item.name} onChange={this._onChange.bind(this)}/><label>{item.name}</label></div>
    });
        ...
        <div className={ styles.container }>
          <div className={ styles.row }>
            <div className={ styles.column }>
              ...
              <a className={ styles.button } onClick={this._AddWebpart.bind(this)}>
  ...
  private async _removeWebpart(){
    const page = await ClientsidePageFromFile(sp.web.getFileByServerRelativePath("/sites/MigrationData/SitePages/Home.aspx"));
